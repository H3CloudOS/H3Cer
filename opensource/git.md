...
- [GUI Clients](https://git-scm.com/downloads/guis) 官方汇总各图形客户端，包括Mac、Windows、Linux下的客户端，免费及付费的都有。推荐直接勇士Github Desktop。
- [Git for windows](https://msysgit.github.io/) 针对 Window 系统发布的客户端，集成了 Shell 窗口，方便在 Win 下面使用命令操作。

## git书籍
- [Pro Git](https://git-scm.com/book/en/v2) 作者Scott Chacon是 Github 的员工，中文版《[Pro Git (Editon 2)](https://git-scm.com/book/zh/v2)》。
- [Git-internals-pdf](https://github.com/pluralsight/git-internals-pdf) 老外写的，很给力，从目录上面包括安装使用以及设计原理都有讲解。
